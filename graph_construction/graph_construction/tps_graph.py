...
class tps_graph:
    ...
    def __init__(self, bgp:BGP, featurizer) -> None:
        ...
        self.edges: list[(int, int, int)] = self.get_edges(self.bgp.triples) #triple1 triple2 relationtype
    ...
    def get_common_edge_type(self, trp1: TriplePattern, trp2: TriplePattern, common_vars):
        edges = []
...
def create_dummy_dgl_graph():
    ...
    featurizer = BaseFeaturizer( train_log = train_log, is_pred_clust_feat=True,save_pred_graph_png = None, community_no=10,path_pred_clust = { 'save_path':None, 'load_path':'/work/data/confs/May2/pred_clust.json'})
