...
python3 /PlanRGCN/scripts/post_predict_unseen.py -s /data/wikidata_3_class_full -t 5 -f /data/wikidata_3_class_full/plan_5_int/test_pred.csv -a Plan5int -o results/ --objective objective.py
exit()
